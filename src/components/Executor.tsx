...
interface State {
    ...
    actionsIterator?: ListIterator<any>;
    currentStep: number;
    totalSteps: number;
    hasPrevious: boolean;
    hasNext: boolean;
...
class EmptyIterator implements ListIterator<Action> {
    private readonly emptyAction: Action = { animate: () => { } };
    previous = (): Action => this.emptyAction;
    hasPrevious = (): boolean => false;
    previousIndex = (): number => -1;
    next = (): Action => this.emptyAction;
...
export default class extends React.Component<Props, State> implements Animatable {
    ...
    readonly state = {
        ...
        hasPrevious: false,
        hasNext: false,
        actionsIterator: new EmptyIterator(),
        isRunning: false
    }

    private readonly handleBuildClick = (that: React.Component<Props, State>) => {

        const parentHTML = document.getElementById("visual") as HTMLElement
